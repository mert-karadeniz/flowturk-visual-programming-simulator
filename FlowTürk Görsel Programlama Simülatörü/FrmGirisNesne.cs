...
{
    public partial class FrmGirisNesne : Form
    {
        public FrmGirisNesne()
        {
            InitializeComponent();
        }
        ...
        private void FrmGirisNesne_Load(object sender, EventArgs e)
        {
            TumDegiskenler();
            GelenIfade();
        }

        private void FrmGirisNesne_FormClosed(object sender, FormClosedEventArgs e)
        {
            GelenIfadeGuncelle();
        }
    }
